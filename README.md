...
const.hで #define されている **MY_SSID** と **MY_PASSWORD** を変更
...
APIは基本的にGET|POSTの /messagesしか使えないと思った方が良い。(/wifiも使えるようにしたかったが、与える文字列を生成するのに、Objective-Cの[ここのソース](https://github.com/irkit/ios-sdk/blob/master/IRKit/IRKit/IRKeys.m#L84)を読まないといけないらしく、ちょっと萎えているところ。)
